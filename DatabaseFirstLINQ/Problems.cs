...
namespace DatabaseFirstLINQ
{
    class Problems
    {
        ...
        private void ProblemThree()
        {
            ...
            var greaterThanOneFifty = products.Where(p => p.Price > 150);

            foreach (var product in greaterThanOneFifty)
            {
        ...
        private void ProblemFour()
        {
            ...
            var products = _context.Products;
            var containsS = products.Where(s => s.Name.Contains("s"));

            foreach (var product in containsS)
            {
        ...
        private void ProblemFive()
        {
            ...
            var users = _context.Users;
            var before2016 = users.Where(b => b.RegistrationDate.Value.Year <= 2016);

            foreach (var user in before2016)
            {
        ...
        private void ProblemNine()
        {
            ...
            var shoppingCartProducts = _context.ShoppingCarts.Include(p => p.Product).Where(e => e.User.Email == "oda@gmail.com").Select(sc => sc.Product.Price).Sum();
        ...
        private void ProblemTen()
        {
            ...
            {
                Console.WriteLine($"Email: {shopping.User.Email} Product Name: {shopping.Product.Name} Price: {shopping.Product.Price} Quanity: {shopping.Quantity}");
            }
        }
        ...
        private void ProblemSixteen()
        {
            ...
            var product = _context.Products.Where(p => p.Name == "Macbook Pro 2021").SingleOrDefault();
            product.Price = 1000;
